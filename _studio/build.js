...
wrap('breed-how', 2400, 1350, `<div style="position:absolute;left:150px;top:100px">${logo()}</div><div class="k" style="position:absolute;right:150px;top:126px">How it works</div>
  ...
  <div style="position:absolute;left:150px;right:150px;top:420px;display:grid;grid-template-columns:repeat(3,1fr);gap:22px">
    <div class="card"><h4>01 · Foal</h4><b>Pick a breed</b><p>Thoroughbred chases breakaways. Mustang fades pumps. Pony scalps at 3x. Clydesdale pulls the index. Arabian runs with the herd. $1,000 paper each, up to 3 per wallet.</p></div>
    ...
    <div class="card" style="background:#eef4fc"><h4>04 · Owner's Desk</h4><b>Trade it yourself</b><p>$10,000 paper USDC on the same 22 tokenized stocks the horses trade, up to 3x. Your book sits on the leaderboard next to theirs.</p></div>
    ...
    <div class="card" style="background:#fff7ec"><h4>06 · On Arc</h4><b>USDC gas, live tape</b><p>Prices from the exchange tape every 15 seconds, extended hours included. Paper books, real prices, on Arc.</p></div>
  </div>
  <div class="mono" style="position:absolute;left:150px;bottom:70px;font-size:28px;color:#2f578c">breedonarc.xyz</div><div class="mono mut" style="position:absolute;right:150px;bottom:70px;font-size:24px">not financial advice · horses lose in public on purpose</div>`);
...
wrap('breed-desk', 2400, 1350, `<div style="position:absolute;left:150px;top:100px">${logo()}</div><div class="k" style="position:absolute;right:150px;top:126px">Owner's Desk · ride along</div>
  ...
  <div style="position:absolute;left:1440px;right:150px;top:420px;display:flex;flex-direction:column;gap:20px">
    <div class="card" style="padding:26px 30px"><h4>Desk</h4><p style="font-size:24px">$10,000 paper USDC. Long or short any of the 22 names, up to 3x, 8 open at once. Same tape the horses trade.</p></div>
  ...
  <div class="mono" style="position:absolute;left:150px;bottom:70px;font-size:28px;color:#2f578c">breedonarc.xyz</div><div class="mono mut" style="position:absolute;right:150px;bottom:70px;font-size:24px">paper books · real prices · on Arc</div>`);
console.log('built 6');
